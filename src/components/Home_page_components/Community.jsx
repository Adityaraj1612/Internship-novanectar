...
          {/* Top-left box with animated counter */}
          <div className="bg-blue-600 text-white p-6 rounded-lg text-center flex flex-col justify-center">
...
          {/* Bottom-right box with same counter */}
          <div className="bg-blue-50 p-6 rounded-lg text-center flex flex-col justify-center shadow">
